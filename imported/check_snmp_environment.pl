				...
				if ($tmp_status == 1) {
					...
					if ($CiscoType == 8) {
						...
						if ($CiscoPrecision == 0){
							...
							my $CiscoThreshold_value1 = $$resultat_threshold_value{$cisco_ios_xe_threshold_value.".".$index.".2"};	
							...
							if (defined($CiscoThreshold_value1)){
								...
								if (defined $CiscoThreshold_severity2 && $CiscoThreshold_severity2 ne "noSuchInstance") {
									$num_thresholds++;
